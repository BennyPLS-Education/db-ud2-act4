...
CREATE DATABASE IF NOT EXISTS negoci;

USE negoci; 



CREATE TABLE IF NOT EXISTS negoci.DEPT (
...
INSERT INTO negoci.DEPT VALUES (10, 'COMPTABILITAT', 'SEVILLA');
INSERT INTO negoci.DEPT VALUES (20, 'INVESTIGACIÓ', 'MADRID');
INSERT INTO negoci.DEPT VALUES (30, 'VENDES', 'BARCELONA');
INSERT INTO negoci.DEPT VALUES (40, 'PRODUCCIÓ', 'BILBAO');


CREATE TABLE IF NOT EXISTS negoci.EMP (
 EMP_NO    INT (4) UNSIGNED,
 COGNOM    VARCHAR (20) NOT NULL,
 NOM       VARCHAR (20),
 OFICI     VARCHAR (10) NOT NULL,
 CAP       INT (4) UNSIGNED,
 DATA_ALTA DATE,
 SALARI    INT UNSIGNED,
 ...
 FOREIGN KEY (DEPT_NO) REFERENCES negoci.DEPT(DEPT_NO)) ;


CREATE INDEX EMP_COGNOM ON negoci.EMP (COGNOM);
CREATE INDEX EMP_DEPT_NO_EMP ON negoci.EMP (DEPT_NO,EMP_NO);

INSERT INTO negoci.EMP VALUES (7369,'SÁNCHEZ',NULL,'EMPLEAT',7902, '1980-12-17', 104000,NULL,20);
INSERT INTO negoci.EMP VALUES (7499,'ARROYO',NULL,'VENEDOR',7698, '1980-02-20', 208000,39000,30);
INSERT INTO negoci.EMP VALUES (7521,'SALA',NULL,'VENEDOR',7698, '1981-02-22', 162500,65000,30);
INSERT INTO negoci.EMP VALUES (7566,'JIMÉNEZ',NULL,'DIRECTOR',7839, '1981-04-02', 386750,NULL,20);
INSERT INTO negoci.EMP VALUES (7654,'MARTÍN',NULL,'VENEDOR',7698, '1981-09-29', 162500,182000,30);
INSERT INTO negoci.EMP VALUES (7698,'NEGRO',NULL,'DIRECTOR',7839, '1981-05-01', 370500,NULL,30);
INSERT INTO negoci.EMP VALUES (7782,'CEREZO',NULL,'DIRECTOR',7839, '1981-06-09', 318500,NULL,10);
INSERT INTO negoci.EMP VALUES (7788,'GIL',NULL,'ANALISTA',7566, '1981-11-09', 390000,NULL,20);
INSERT INTO negoci.EMP VALUES (7839,'REY',NULL,'PRESIDENT',NULL, '1981-11-17', 650000,NULL,10);
INSERT INTO negoci.EMP VALUES (7844,'TOVAR',NULL,'VENEDOR',7698, '1981-09-08', 195000,0,30);
INSERT INTO negoci.EMP VALUES (7876,'ALONSO',NULL,'EMPLEAT',7788, '1981-09-23', 143000,NULL,20);
INSERT INTO negoci.EMP VALUES (7900,'JIMENO',NULL,'EMPLEAT',7698, '1981-12-03', 123500,NULL,30);
INSERT INTO negoci.EMP VALUES (7902,'FERNÁNDEZ',NULL,'ANALISTA',7566, '1981-12-03', 390000,NULL,20);
INSERT INTO negoci.EMP VALUES (7934,'MUÑOZ',NULL,'EMPLEAT',7782, '1982-01-23', 169000,NULL,10);


ALTER TABLE negoci.EMP
ADD FOREIGN KEY (CAP) REFERENCES EMP(EMP_NO);



CREATE TABLE IF NOT EXISTS negoci.CLIENT (
 ...
 FOREIGN KEY (REPR_COD) REFERENCES negoci.EMP(EMP_NO));

CREATE INDEX CLIENT_NOM ON negoci.CLIENT (NOM);
CREATE INDEX CLIENT_REPR_CLI ON negoci.CLIENT (REPR_COD, CLIENT_COD);


INSERT INTO negoci.CLIENT (CLIENT_COD, NOM, ADRECA, CIUTAT, ESTAT, CODI_POSTAL, AREA, 
...
CREATE TABLE IF NOT EXISTS negoci.PRODUCTE (
 PROD_NUM     INT (6) UNSIGNED PRIMARY KEY,
 DESCRIPCIO   VARCHAR (30) NOT NULL  UNIQUE);


INSERT INTO negoci.PRODUCTE (PROD_NUM, DESCRIPCIO)
...
CREATE TABLE IF NOT EXISTS negoci.COMANDA  (
 ...
 FOREIGN KEY (CLIENT_COD) REFERENCES negoci.CLIENT(CLIENT_COD) );

CREATE INDEX COMANDA_DATA_NUM ON negoci.COMANDA (COM_DATA,COM_NUM);
CREATE INDEX COMANDA_TRAMESA_NUM ON negoci.COMANDA (DATA_TRAMESA,COM_NUM);


INSERT INTO negoci.COMANDA (COM_NUM, COM_DATA, COM_TIPUS, CLIENT_COD, DATA_TRAMESA, TOTAL)
...
CREATE TABLE IF NOT EXISTS negoci.DETALL  (
 ...
 FOREIGN KEY (COM_NUM) REFERENCES negoci.COMANDA(COM_NUM),
 FOREIGN KEY (PROD_NUM) REFERENCES negoci.PRODUCTE(PROD_NUM));


CREATE INDEX DETALL_PROD_COM_DET ON negoci.DETALL (PROD_NUM,COM_NUM,DETALL_NUM);


INSERT INTO negoci.DETALL (COM_NUM, DETALL_NUM, PROD_NUM, PREU_VENDA, QUANTITAT, IMPORT)
